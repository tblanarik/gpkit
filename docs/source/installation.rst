...
Mac OS X
  ...
  - Request an `academic license file <https://www.mosek.com/products/academic-licenses/>`_ and put it in ``~/mosek/``
...
Windows
    ...
    - Request an `academic license file <https://www.mosek.com/products/academic-licenses/>`_ and put it in ``C:\Users\(your_username)\mosek\``
